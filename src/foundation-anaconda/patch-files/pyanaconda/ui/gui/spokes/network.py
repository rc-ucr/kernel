...
from gi.repository import GLib, GObject, Pango, Gio, NM as NetworkManager
# ROCKS8 removed NMClient as separate object. Now: NM.Client
...
class NetworkControlBox(GObject.GObject):
    ...
    def __init__(self, builder, spoke=None):
        ...
        self.remote_settings = NM.Client.RemoteSettings()
        ...
        self.builder.get_object("device_wireless_off_switch").connect("notify::active",
                                                             self.on_device_off_toggled)
        self.client.connect("notify::%s" % NM.Client.CLIENT_WIRELESS_ENABLED,
        ...
        self.client.connect("notify::%s" % NM.Client.CLIENT_STATE,
